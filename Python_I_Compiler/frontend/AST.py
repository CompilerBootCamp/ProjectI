import sys
sys.path.append('../')
from utils import _Type_Int,_Type_Float,_Type_Boolean,gattrs
...
class RecordMemberDecl(ASTNode):
  def __init__(self,var_name,typep):
    self.var_name=var_name
    self.type=typep
...
class VarDeclNode(ASTNode):
  def __init__(self,name_var,typenode, init=None):
