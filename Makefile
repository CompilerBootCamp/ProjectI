...
$(BUILD_DIR)/main.o : $(BUILD_DIR)/Compiler.o
	$(CC) $(CFLAGS) -I$(COMMON_DIR) -I$(LEXER_DIR) $(BUILD_DIR)/Token.o $(BUILD_DIR)/Compiler.o $(BUILD_DIR)/HandLexer.o -o $@ $(COMMON_DIR)/main.cpp

$(BUILD_DIR)/Compiler.o : $(BUILD_DIR)/HandLexer.o $(BUILD_DIR)/Token.o 
...
$(BUILD_DIR)/Token.o:
	$(CC) $(CFLAGS) -I$(COMMON_DIR) -c -o $@ $(COMMON_DIR)/Token.cpp